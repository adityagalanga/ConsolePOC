...
namespace Nagih
{
    public class RequestManager : MonoBehaviour
    {
        ...
        public void LoadAsset(GameObject frontLoading)
        {
            _frontLoading = frontLoading;
            _backLoading = Instantiate(Resources.Load<GameObject>(Const.RESLOC_LOADING_BACK), transform);
        }
        ...
        public byte[] CreateSocketRequest(SocketType type, IRequestData data)
        {
            WebSocketConnectionData connData = new WebSocketConnectionData((int)type,data);
        ...
        public void Post<T>(string type, IRequestData data, Action<T> callback) where T : IReturnData, new()
        {
            ...
            ConnectionData<T> connData = new ConnectionData<T>(type, _token, data, callback);
