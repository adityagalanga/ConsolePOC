...
namespace Nagih
{
    public class TutorialManager : MonoBehaviour
    {
        ...
        public void Initialize()
        {
            if (!IsInitialize)
            {
                Parent = Instantiate(Resources.Load<GameObject>(Const.RESLOC_TUTORIAL_CANVAS), transform).transform;
                Box = Instantiate(Resources.Load<GameObject>(Const.RESLOC_TUTORIAL_BOX), Parent).GetComponent<TutorialBox>();
                Arrow = Instantiate(Resources.Load<GameObject>(Const.RESLOC_TUTORIAL_ARROW), Parent).GetComponent<TutorialArrow>();
                Overlay = Instantiate(Resources.Load<GameObject>(Const.RESLOC_TUTORIAL_OVERLAY), Parent).GetComponent<TutorialOverlay>();
